...
$target_file_paradb = $target_dir . basename($_FILES["fotoch"]["name"]);
                    ...
                    && $imageFileType != "gif" ) {
                        echo "Solo JPG, JPEG, PNG & GIF son aceptados.".basename($_FILES["fotoch"]["name"]).' - '.$imageFileType;
                        $uploadOk = 0;
                    }
                    ...
                    if($subido==1){
                          $sql='update productos set produ_imagen="'.$target_file_paradb.'" where produ_id="'.$produ_id.'"';
                       $result=mysqli_query($link,$sql);
                        ...
                        //De lo contrario regresa al index
                            ...
                            echo "<script language=Javascript> location.href=\"admin-editar-productos.php?produ_id=".$produ_id."&ok\"; </script>";
                        }
                    }
